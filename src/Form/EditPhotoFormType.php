            ...
            ->add('photo', FileType::class, [
                ...
                'constraints' => [
                    ...
                    new File([
                        ...
                        'maxSizeMessage' => 'Fichier trop volumineux ({{size}} {{suffix}}). La taille maximum autorisée est de {{maxSize}} {{suffix}} ',
                        'mimeTypes' => $this->allowedMimeTypes,
                        'mimeTypesMessage' => 'Ce type de fichiez n\'est pas autorisé ({{ type }}).Les fichiers autorisés sont {{ types }}',
